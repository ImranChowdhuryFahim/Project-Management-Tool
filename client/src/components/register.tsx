                ...
                <div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            <label htmlFor="displayName" className="text-xs font-semibold px-1">Name</label>
                            <div className="flex">
                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input name="displayName" onChange={(e)=>{setDisplayName(e.target.value)}} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"></input>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            ...
                            <div className="flex">
                                ...
                                <input type="email" onChange={(e)=>{setEmail(e.target.value)}} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com"></input>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            ...
                            <div className="flex">
                                ...
                                <input type="password" onChange={(e)=>{setPassword(e.target.value)}} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"></input>
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            <button onClick={()=>{handleSubmit()}} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Sign Up</button>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full flex px-3 mb-5">
                            <p>Already have an account?</p> 
                            <Link className="px-3 text-black" href={'/'}>Login</Link>
                        </div>
                    </div>
                </div>
            </div>
